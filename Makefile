...
run-lambda-docker:
	docker run -p 8181:8181 openplugin-lambda

run-lambda-docker-bg:
	docker run -p 8181:8181 -d openplugin-lambda
...
run-docker:
	docker run -p 8181:8181 openplugin

run-docker-bg:
	docker run -p 8181:8181 -d openplugin
